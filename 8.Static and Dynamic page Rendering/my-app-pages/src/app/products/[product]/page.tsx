...
// props is an object which caries a key of product(name of our folder) than the value of it will be the route we provide after products. Like here localhost:3000/products/Clothes, Clothes will be the value of params.product
...
// we have given the name of folder(product) in a square bracket so that we can use it with any name after products/ in search bar like milk or yogurt or any id like 123 or anyother we want